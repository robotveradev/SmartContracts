                    ...
                    describe('after verify member', async function () {
                        ...
                        describe('after add new fact', async function () {
                            ...
                            describe('after member_2 verify member fact', async function () {
                                ...
                                it('member_2 verify fact', async function () {
                                    let already_verify = await this.oracle.member_fact_confirmations(this.member_2.address, this.member.address, fact_uuid);
                                    console.log(already_verify);
                                    assert.isTrue(already_verify);
                                });
