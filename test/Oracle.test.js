...
contract('Oracle', function (accounts) {
    ...
    beforeEach(async function () {
        ...
        this.oracle = await Oracle.new(_name, _service_fee, _beneficiary, this.token.address, this.facts.address);
        ...
        describe('oracle main', async function () {
            ...
            describe('after add new member', async function () {
                ...
                describe('member facts', async function () {
                    ...
                    beforeEach(async function () {
                        this.fact = {'time': 145142123, 'fact': 'test fact one', 'sender': member};
                    });

                     it('not verified member can add new fact', async function () {
                         await this.oracle.new_fact(this.member.address, JSON.stringify(this.fact), fact_uuid, {from: member});
                     });
                    ...
                    describe('after verify member', async function () {
                        ...
                        beforeEach(async function () {
                         ...
                         it('member verified', async function () {
                        ...
                        describe('after add new fact', async function () {
                            ...
                            beforeEach(async function () {
                                await this.oracle.new_fact(this.member.address, JSON.stringify(this.fact), fact_uuid);
                            });

                             it('verified member can\'t verify his own fact', async function () {
                            ...
                            describe('after another member verify member fact', async function () {
                                beforeEach(async function () {
                                    await this.member_2.verify_fact(this.member.address, fact_uuid, {from: member_2});
                                });

                                 it('another member can\'t confirm fact twice', async function () {
